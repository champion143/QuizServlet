...
public class check5 extends HttpServlet
{
	public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
	{
     ...
     String n=request.getParameter("q9");  
     String i=request.getParameter("q10"); 
	 String sql="insert into QUIZ values(?,?,?,?,?)";
	 pw.println("<html><head></head><body>");
	 pw.println("<form action='firstpage.html' method='post'></br><input type='submit' value='close'></input></form>");
	 int attempt=0;
	 int notattempt=0;
	 int correct=0;
	 int notcorrect=0;
	 ...
	 PreparedStatement ps;
      ...
      System.out.println("just checking purpose5");
      rs.last();
