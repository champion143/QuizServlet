...
public class check4 extends HttpServlet
{
	public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException,IOException
	{
     response.setContentType("text/html");	
	 PrintWriter pw = response.getWriter(); 
     String n=request.getParameter("q7");  
     String i=request.getParameter("q8"); 
	...
	// pw.println("<html><head></head><body>");
     ...
     System.out.println("just checking purpose4");
     rs.last();
  ...
  //    pw.println(count);
    ...
    //   pw.println("Your Data has been successfully stored in database");
        	response.sendRedirect("question5.html");
      }
     else
      {
